...
func (c *usersService) Register(ctx context.Context, in *RegisterRequest, opts ...client.CallOption) (*RegisterResponse, error) {
...
func (h *usersHandler) Register(ctx context.Context, in *RegisterRequest, out *RegisterResponse) error {
